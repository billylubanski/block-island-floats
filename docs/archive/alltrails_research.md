...
Archived on 2026-03-21. Preserved as a historical evaluation of potential map-link integrations.
...
2. There is no public API for deep linking.
3. Web links work but aren't better than Google Maps or Apple Maps.
4. Google Maps and Apple Maps already work well.
5. Those apps show beaches, roads, and coastal access better.
