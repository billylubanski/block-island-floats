...
Archived on 2026-03-21. Preserved as a point-in-time implementation note for the dashboard recovery-rate update.
...
- Progress bar shows percentage of floats recovered (found/hidden x 100)
...
- `templates/index.html` - Updated the Finds by Year table
